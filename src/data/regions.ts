...
export const REGIONS = {
  ...
  US_Permian: {
    ...
    roles: [PRODUCTION], exploitableGrades: [LIGHT_SWEET], laborCostIndex: 1.15, infrastructureTariff: 0.50, declineClass: SHALE,
  },
  US_Gulf_Coast: {
    displayName: 'US Gulf Coast', continent: 'North America', coverage: 'US Gulf offshore and Gulf Coast refining',
    roles: [PRODUCTION, REFINING], exploitableGrades: [MEDIUM, HEAVY_SOUR], laborCostIndex: 1.20, infrastructureTariff: 0.60, declineClass: CONVENTIONAL,
  },
  Western_Canada: {
    displayName: 'Alberta Oil Sands', continent: 'North America', coverage: 'Alberta oil sands',
    roles: [PRODUCTION], exploitableGrades: [HEAVY_SOUR], laborCostIndex: 1.10, infrastructureTariff: 1.80, declineClass: CONVENTIONAL,
  },
  Mexico_Gulf: {
    displayName: 'Bay of Campeche', continent: 'North America', coverage: 'Mexican Gulf of Mexico fields',
    roles: [PRODUCTION, REFINING], exploitableGrades: [HEAVY_SOUR, MEDIUM], laborCostIndex: 0.70, infrastructureTariff: 1.20, declineClass: CONVENTIONAL,
  },

  // Central & South America
  Venezuela_Orinoco: {
    displayName: 'Orinoco Belt', continent: 'Central & South America', coverage: 'Orinoco Belt and Maracaibo',
    roles: [PRODUCTION], exploitableGrades: [HEAVY_SOUR], laborCostIndex: 0.60, infrastructureTariff: 2.00, declineClass: CONVENTIONAL,
  },
  Colombia_Andean: {
    displayName: 'Andean Basins', continent: 'Central & South America', coverage: 'Colombia and Ecuador',
    roles: [PRODUCTION], exploitableGrades: [HEAVY_SOUR, MEDIUM], laborCostIndex: 0.70, infrastructureTariff: 1.30, declineClass: CONVENTIONAL,
  },
  Guyana_Suriname: {
    displayName: 'Guiana Basin', continent: 'Central & South America', coverage: 'Guyana and Suriname offshore',
    roles: [PRODUCTION], exploitableGrades: [LIGHT_SWEET, MEDIUM], laborCostIndex: 0.90, infrastructureTariff: 0.80, declineClass: CONVENTIONAL,
  },
  Brazil_Presalt: {
    displayName: 'Santos & Campos Basins', continent: 'Central & South America', coverage: 'Santos and Campos basins',
    roles: [PRODUCTION, REFINING], exploitableGrades: [MEDIUM], laborCostIndex: 0.85, infrastructureTariff: 1.10, declineClass: CONVENTIONAL,
  },
  Argentina_Vaca_Muerta: {
    displayName: 'Vaca Muerta', continent: 'Central & South America', coverage: 'Neuquén shale',
    roles: [PRODUCTION], exploitableGrades: [LIGHT_SWEET], laborCostIndex: 0.80, infrastructureTariff: 1.50, declineClass: SHALE,
  },

  // Europe
  North_Sea: {
    displayName: 'North Sea', continent: 'Europe', coverage: 'UK and Norwegian shelf, NW European refining',
    roles: [PRODUCTION, REFINING], exploitableGrades: [MEDIUM, LIGHT_SWEET], laborCostIndex: 1.40, infrastructureTariff: 2.50, declineClass: CONVENTIONAL,
  },
  Southern_Europe: {
    displayName: 'Mediterranean Coast', continent: 'Europe', coverage: 'Mediterranean refining coast',
    roles: [REFINING], exploitableGrades: [], laborCostIndex: 1.10, infrastructureTariff: 1.50, declineClass: CONVENTIONAL,
  },

  // Russia & Caspian
  Russia_West: {
    displayName: 'Volga-Urals', continent: 'Russia & Caspian', coverage: 'Volga-Urals and West Siberia, Baltic and Black Sea export',
    roles: [PRODUCTION, REFINING], exploitableGrades: [MEDIUM], laborCostIndex: 0.65, infrastructureTariff: 1.00, declineClass: CONVENTIONAL,
  },
  Russia_Far_East: {
    displayName: 'Sakhalin & East Siberia', continent: 'Russia & Caspian', coverage: 'East Siberia and Sakhalin, Pacific export',
    roles: [PRODUCTION], exploitableGrades: [LIGHT_SWEET, MEDIUM], laborCostIndex: 0.75, infrastructureTariff: 1.00, declineClass: CONVENTIONAL,
  },
  Caspian: {
    displayName: 'Caspian Basin', continent: 'Russia & Caspian', coverage: 'Kazakhstan and Azerbaijan',
    roles: [PRODUCTION], exploitableGrades: [LIGHT_SWEET, MEDIUM], laborCostIndex: 0.70, infrastructureTariff: 1.20, declineClass: CONVENTIONAL,
  },

  // Africa (outside the Middle East)
  North_Africa: {
    displayName: 'North Africa', continent: 'Africa', coverage: 'Libya, Algeria and Egypt',
    roles: [PRODUCTION], exploitableGrades: [LIGHT_SWEET, MEDIUM], laborCostIndex: 0.65, infrastructureTariff: 0.90, declineClass: CONVENTIONAL,
  },
  West_Africa: {
    displayName: 'Gulf of Guinea', continent: 'Africa', coverage: 'Nigeria, Angola and the Gulf of Guinea',
    roles: [PRODUCTION], exploitableGrades: [LIGHT_SWEET, MEDIUM], laborCostIndex: 0.85, infrastructureTariff: 1.40, declineClass: CONVENTIONAL,
  },

  // Middle East
  Middle_East: {
    displayName: 'Persian Gulf', continent: 'Middle East', coverage: 'Persian Gulf producers inside the Strait of Hormuz',
    roles: [PRODUCTION, REFINING], exploitableGrades: [LIGHT_SWEET, MEDIUM, HEAVY_SOUR], laborCostIndex: 0.75, infrastructureTariff: 0.20, declineClass: CONVENTIONAL,
  },
  Red_Sea_Coast: {
    ...
    roles: [TERMINAL], exploitableGrades: [], laborCostIndex: 0.75, infrastructureTariff: 0.30, declineClass: CONVENTIONAL,
  },
  Gulf_of_Oman: {
    displayName: 'Gulf of Oman', continent: 'Middle East', coverage: 'Oman and Fujairah, outside the Strait',
    roles: [PRODUCTION, TERMINAL], exploitableGrades: [MEDIUM, HEAVY_SOUR], laborCostIndex: 0.80, infrastructureTariff: 0.30, declineClass: CONVENTIONAL,
  },

  // Asia-Pacific
  Southeast_Asia: {
    displayName: 'Southeast Asia', continent: 'Asia-Pacific', coverage: 'Malaysia, Indonesia and Brunei',
    roles: [PRODUCTION, REFINING], exploitableGrades: [LIGHT_SWEET, MEDIUM], laborCostIndex: 0.70, infrastructureTariff: 0.90, declineClass: CONVENTIONAL,
  },
  Coastal_Asia: {
    displayName: 'East Asian Coast', continent: 'Asia-Pacific', coverage: 'China, Japan and Korea coastal refining',
    roles: [REFINING], exploitableGrades: [], laborCostIndex: 0.80, infrastructureTariff: 1.00, declineClass: CONVENTIONAL,
  },
  South_Asia: {
    displayName: 'Indian West Coast', continent: 'Asia-Pacific', coverage: 'Indian west coast refining',
    roles: [REFINING], exploitableGrades: [], laborCostIndex: 0.55, infrastructureTariff: 1.20, declineClass: CONVENTIONAL,
  },
