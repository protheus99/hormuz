...
**Status:** In build — engine Phases 0–7, the game session (Phase 8) and decision cards (Phase 9) complete; the Phase 10 interface is built and playable, with its tutorials (which need the Phase 11 campaign), playtests and trademark search still to come. This is the single source of truth for the Hormuz game and its market engine (GEMS, the Global Energy Market Simulator). It supersedes all earlier GEMS specifications and prototypes.
...
| Charter a tanker *(Opp)* | Always available | Large, 90 days | Small, 30 days | Charter |
