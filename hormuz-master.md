...
| **4. Lane graph & logistics** | Heap, Dijkstra, lane graph as route provider, cargo states, delivery overflow | Default paths match the §3.5 sanity table; closing Hormuz routes Gulf cargo via bypass until capacity binds; closing Bab el-Mandeb reroutes via the Cape; held cargo does not advance |
